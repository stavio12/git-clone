            ...
            <div className="card border rounded pinned-container">
              <div className="card-body position-relative">
                <div className="card-title d-flex flex-row justify-content-between align-items-center">
                  <div>
                    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo mr-2 text-muted flex-shrink-0" style={{ fill: "#8b949e" }}>
                  ...
                  <span className="h6 text-muted text-small d-flex flex-row align-items-center gap-2">
                    ...
                    <div {...provided.dragHandleProps}>
                      {" "}
                      <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-grabber mx-2" style={{ fill: "#8b949e" }}>
                  ...
                  <div className="d-flex flex-row align-items-center gap-3 text-small text-muted position-absolute bottom-0 language">
                    ...
                    <div>
                      <span class="d-flex flex-row align-items-center gap-1">
                        <svg aria-label="stars" role="img" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star" style={{ fill: "#8b949e" }}>
                    ...
                    <div className={repo.forks === 0 ? "d-none" : "d-block"}>
                      <span class="d-flex flex-row align-items-center gap-1">
                        <svg aria-label="fork" role="img" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" style={{ fill: "#8b949e" }} class="octicon octicon-repo-forked">
